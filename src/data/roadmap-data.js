...
export const DSA = [
  {
    id: "dsa-1",
    week: "W1",
    title: "Arrays & Strings: Pattern Recognition Bootcamp",
    level: "Beginner",
    pattern: "Two pointers · Sliding window · Prefix sums · Frequency maps",
    topics: [
      {
        id: "dsa-1-1",
        text: "Solve: Two Sum, Best Time to Buy/Sell Stock (single-pass tracking)",
        diff: "Easy",
      },
      {
        id: "dsa-1-2",
        text: "Solve: Valid Anagram, Group Anagrams, First Unique Char (frequency maps in JS)",
        diff: "Easy",
      },
      {
        id: "dsa-1-3",
        text: "Two-Pointer Drill: Reverse String, Valid Palindrome, Container With Most Water",
        diff: "Easy",
      },
      {
        id: "dsa-1-4",
        text: "Sliding Window Drill: Longest Substring Without Repeating Chars, Max Sum Subarray of Size K",
        diff: "Medium",
      },
      {
        id: "dsa-1-5",
        text: "Prefix Sum Drill: Range Sum Queries, Subarray Sum Equals K (with hashmap)",
        diff: "Medium",
      },
      {
        id: "dsa-1-6",
        text: "Mock Interview: Talk through Big-O of each solution above out loud (whiteboard style)",
        diff: "Easy",
      },
    ],
  },
  {
    id: "dsa-2",
    week: "W2",
    title: "Arrays Continued: Sorting Tricks & In-Place Manipulation",
    level: "Beginner",
    pattern: "In-place swaps · Kadane's · Dutch flag · Cyclic sort",
    topics: [
      {
        id: "dsa-2-1",
        text: "Solve: Maximum Subarray (Kadane's) — trace through with a number line",
        diff: "Medium",
      },
      {
        id: "dsa-2-2",
        text: "Solve: Sort Colors (Dutch National Flag) and Move Zeroes (in-place pointers)",
        diff: "Medium",
      },
      {
        id: "dsa-2-3",
        text: "Solve: Majority Element (Boyer-Moore Voting) — explain why it works",
        diff: "Medium",
      },
      {
        id: "dsa-2-4",
        text: "Solve: Product of Array Except Self (no division allowed)",
        diff: "Medium",
      },
      {
        id: "dsa-2-5",
        text: "Solve: Merge Intervals, Insert Interval — sort + merge pattern",
        diff: "Medium",
      },
      {
        id: "dsa-2-6",
        text: "Speed Round: Re-solve 3 problems from W1 from scratch, timed (20 min each)",
        diff: "Medium",
      },
    ],
  },
  {
    id: "dsa-3",
    week: "W3",
    title: "Stacks, Queues & Matrices: Simulation Problems",
    level: "Beginner",
    pattern: "LIFO/FIFO simulation · Monotonic stack · Grid BFS/DFS",
    topics: [
      {
        id: "dsa-3-1",
        text: "Solve: Valid Parentheses, Min Stack, Evaluate Reverse Polish Notation",
        diff: "Easy",
      },
      {
        id: "dsa-3-2",
        text: "Solve: Sliding Window Maximum using a Deque (visualize the shrinking window)",
        diff: "Medium",
      },
      {
        id: "dsa-3-3",
        text: "Monotonic Stack Drill: Daily Temperatures, Next Greater Element",
        diff: "Medium",
      },
      {
        id: "dsa-3-4",
        text: "Solve: Spiral Matrix, Rotate Image (in-place matrix manipulation)",
        diff: "Medium",
      },
      {
        id: "dsa-3-5",
        text: "Solve: Number of Islands, Flood Fill (BFS/DFS on grids — JS recursion limits)",
        diff: "Medium",
      },
    ],
  },
  {
    id: "dsa-4",
    week: "W4",
    title: "Linked Lists: Pointer Manipulation Without Bugs",
    level: "Beginner",
    pattern: "Dummy nodes · Fast/slow pointers · In-place rewiring",
    topics: [
      {
        id: "dsa-4-1",
        text: "Solve: Reverse Linked List (iterative + recursive) — draw the pointer flips",
        diff: "Easy",
      },
      {
        id: "dsa-4-2",
        text: "Solve: Linked List Cycle (Floyd's), Find Cycle Start, Happy Number",
        diff: "Medium",
      },
      {
        id: "dsa-4-3",
        text: "Solve: Merge Two Sorted Lists, Merge K Sorted Lists (with heap)",
        diff: "Medium",
      },
      {
        id: "dsa-4-4",
        text: "Solve: Remove Nth Node From End, Reorder List (using dummy node + two pointers)",
        diff: "Medium",
      },
      {
        id: "dsa-4-5",
        text: "Solve: Copy List with Random Pointer, LRU Cache (combine map + doubly linked list)",
        diff: "Hard",
      },
    ],
  },
  {
    ...
    level: "Intermediate",
    pattern: "Decision trees · Choose/explore/unchoose · Search pruning",
    topics: [
      {
        id: "dsa-5-1",
        text: "Solve: Binary Search + variants (Search Insert Position, Search in Rotated Sorted Array)",
        diff: "Easy",
      },
      {
        id: "dsa-5-2",
        text: "Solve: Merge Sort & Quick Sort implemented from scratch in JS",
        diff: "Medium",
      },
      {
        id: "dsa-5-3",
        text: "Backtracking Drill: Subsets, Permutations, Combination Sum",
        diff: "Medium",
      },
      {
        id: "dsa-5-4",
        text: "Backtracking Drill: Word Search, N-Queens (visualize the pruning)",
        diff: "Hard",
      },
      {
        id: "dsa-5-5",
        text: "Mock Interview: Generate Parentheses + explain time complexity of branching",
        diff: "Medium",
      },
    ],
  },
  {
    id: "dsa-6",
    week: "W6",
    title: "Trees & Heaps: Traversal-Driven Problem Solving",
    level: "Intermediate",
    pattern:
      "DFS/BFS traversal · Recursive tree building · Heap-based selection",
    topics: [
      {
        id: "dsa-6-1",
        text: "Solve: Max Depth, Invert Binary Tree, Same Tree, Diameter of Binary Tree",
        diff: "Easy",
      },
      {
        id: "dsa-6-2",
        text: "Solve: Level Order Traversal, Right Side View, Zigzag Traversal (BFS with queue)",
        diff: "Medium",
      },
      {
        id: "dsa-6-3",
        text: "Solve: Validate BST, Kth Smallest in BST, Lowest Common Ancestor",
        diff: "Medium",
      },
      {
        id: "dsa-6-4",
        text: "Solve: Serialize/Deserialize Binary Tree, Construct Tree from Preorder+Inorder",
        diff: "Hard",
      },
      {
        id: "dsa-6-5",
        text: "Heap Drill: Kth Largest Element, Top K Frequent Elements, Merge K Sorted Lists revisit",
        diff: "Medium",
      },
    ],
  },
  {
    id: "dsa-7",
    week: "W7",
    title: "Graphs: Traversal & Connectivity Problems",
    level: "Intermediate",
    pattern: "Adjacency list building · State arrays · BFS layers",
    topics: [
      {
        id: "dsa-7-1",
        text: "Build adjacency lists from edge lists in JS, then solve Clone Graph",
        diff: "Easy",
      },
      {
        id: "dsa-7-2",
        text: "Solve: Number of Provinces, Number of Connected Components",
        diff: "Medium",
      },
      {
        id: "dsa-7-3",
        text: "Solve: Rotting Oranges, Shortest Path in Binary Matrix (BFS shortest path)",
        diff: "Medium",
      },
      {
        id: "dsa-7-4",
        text: "Solve: Course Schedule I & II (cycle detection + topological sort)",
        diff: "Hard",
      },
      {
        id: "dsa-7-5",
        text: "Solve: Pacific Atlantic Water Flow (multi-source BFS/DFS)",
        diff: "Hard",
      },
    ],
  },
  {
    ...
    level: "Advanced",
    pattern: "Priority queue relaxation · Union-Find with rank · MST building",
    topics: [
      {
        id: "dsa-8-1",
        text: "Solve: Network Delay Time (Dijkstra's with a JS min-heap)",
        diff: "Medium",
      },
      {
        id: "dsa-8-2",
        text: "Solve: Cheapest Flights Within K Stops (Bellman-Ford)",
        diff: "Hard",
      },
      {
        id: "dsa-8-3",
        text: "Implement Union-Find from scratch, then solve Redundant Connection",
        diff: "Medium",
      },
      {
        id: "dsa-8-4",
        text: "Solve: Min Cost to Connect All Points (Prim's / Kruskal's MST)",
        diff: "Hard",
      },
    ],
  },
  {
    id: "dsa-9",
    week: "W9",
    title: "Dynamic Programming I: 1D State & Decisions",
    level: "Advanced",
    pattern: "Recursion → memo → table conversion · Choice-based DP",
    topics: [
      {
        id: "dsa-9-1",
        text: "Solve: Climbing Stairs, House Robber — write recursive, then memo, then tabulated versions",
        diff: "Easy",
      },
      {
        id: "dsa-9-2",
        text: "Solve: Coin Change, Coin Change II (unbounded knapsack pattern)",
        diff: "Medium",
      },
      {
        id: "dsa-9-3",
        text: "Solve: Word Break, Decode Ways (string segmentation DP)",
        diff: "Medium",
      },
      {
        id: "dsa-9-4",
        text: "Solve: Longest Increasing Subsequence (O(n²) then O(n log n))",
        diff: "Hard",
      },
      {
        id: "dsa-9-5",
        text: "Solve: Partition Equal Subset Sum, Target Sum (0/1 knapsack variants)",
        diff: "Hard",
      },
    ],
  },
  {
    id: "dsa-10",
    week: "W10",
    title: "Dynamic Programming II: 2D Grids & Strings",
    level: "Advanced",
    pattern: "Grid traversal DP · String alignment matrices",
    topics: [
      {
        id: "dsa-10-1",
        text: "Solve: Unique Paths, Minimum Path Sum (grid DP with obstacles)",
        diff: "Medium",
      },
      {
        id: "dsa-10-2",
        text: "Solve: Longest Common Subsequence, Longest Palindromic Substring",
        diff: "Hard",
      },
      {
        id: "dsa-10-3",
        text: "Solve: Edit Distance — implement and trace the matrix by hand",
        diff: "Hard",
      },
      {
        id: "dsa-10-4",
        text: "Solve: Burst Balloons or Matrix Chain Multiplication (interval DP)",
        diff: "Hard",
      },
    ],
  },
  {
    id: "dsa-11",
    week: "W11",
    title: "Greedy, Tries & Specialized Structures",
    level: "Advanced",
    pattern: "Local-optimal proofs · Trie traversal · Interval scheduling",
    topics: [
      {
        id: "dsa-11-1",
        text: "Solve: Jump Game I & II, Gas Station (greedy proof-driven problems)",
        diff: "Medium",
      },
      {
        id: "dsa-11-2",
        text: "Solve: Non-overlapping Intervals, Meeting Rooms II",
        diff: "Medium",
      },
      {
        id: "dsa-11-3",
        text: "Implement a Trie from scratch, then solve Word Search II",
        diff: "Hard",
      },
      {
        id: "dsa-11-4",
        text: "Implement LRU Cache and LFU Cache without library Map shortcuts",
        diff: "Hard",
      },
      {
        id: "dsa-11-5",
        text: "Solve: Range Sum Query - Mutable (intro to segment trees, conceptual)",
        diff: "Expert",
      },
    ],
  },
  {
    id: "dsa-12",
    week: "W12",
    title: "Bit Manipulation, Math & Mixed Mock Interviews",
    level: "Expert",
    pattern: "Bit tricks · Modular math · Full mock interview simulation",
    topics: [
      {
        id: "dsa-12-1",
        text: "Solve: Single Number, Counting Bits, Number of 1 Bits (XOR & bitmask tricks)",
        diff: "Easy",
      },
      {
        id: "dsa-12-2",
        text: "Solve: Subsets via Bitmask, Sum of Two Integers (no + operator)",
        diff: "Medium",
      },
      {
        id: "dsa-12-3",
        text: "Solve: Pow(x, n), Sqrt(x) — implement without Math.pow/Math.sqrt",
        diff: "Medium",
      },
      {
        id: "dsa-12-4",
        text: "Full Mock: 2 random mixed-pattern problems, 45 min, explain approach before coding",
        diff: "Hard",
      },
      {
        id: "dsa-12-5",
        text: "Retrospective: Re-categorize every problem solved by pattern, identify weak patterns",
        diff: "Hard",
      },
    ],
  },
